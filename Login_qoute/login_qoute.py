...
REG_VALUE_NAME = "legalnoticecaption"
...
# --- Execute ---
update_registry_string_from_file(DATA_FILE, REG_KEY_PATH, REG_VALUE_NAME)
# --- Example Execution (after your registry change) ---
# NOTE: The actual LegalNoticeCaption setting is usually located under:
# HKEY_LOCAL_MACHINE\Software\Microsoft\Windows\CurrentVersion\Policies\System
# and requires Administrator privileges to change.

# 1. Your Registry modification code goes here (using winreg or subprocess REG ADD)
# ...
